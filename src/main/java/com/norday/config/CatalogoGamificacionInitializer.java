 ...
 *
 * Los logros se comprueban por código, fila a fila, por el mismo motivo que
 * en LogrosHabitosInitializer: la guarda todo-o-nada original no sobrevive
 * al reparto en dos módulos.
 */
@Component
