...
public class LogrosHabitosInitializer implements CommandLineRunner {
    ...
    private static final String[][] LOGROS = {
            ...
            {"RACHA_10", "Dos dígitos", "Alcanza una racha de 10", "Constancia", "Medio", "200"},
            {"RACHA_15", "Quince firmes", "Alcanza una racha de 15", "Constancia", "Medio", "200"},
            {"RACHA_20", "Veinte sin fallar", "Alcanza una racha de 20", "Constancia", "Medio", "200"},
            {"RACHA_25", "Cuarto de cien", "Alcanza una racha de 25", "Constancia", "Medio", "200"},
            {"RACHA_30", "Imparable", "Alcanza una racha de 30", "Constancia", "Dificil", "500"},
            {"RACHA_35", "Más allá del mes", "Alcanza una racha de 35", "Constancia", "Medio", "200"},
            {"RACHA_40", "Cuarenta", "Alcanza una racha de 40", "Constancia", "Medio", "200"},
            {"RACHA_45", "Constancia probada", "Alcanza una racha de 45", "Constancia", "Medio", "200"},
            {"RACHA_50", "Medio centenar", "Alcanza una racha de 50", "Constancia", "Dificil", "500"},
            {"RACHA_55", "Sin mirar atrás", "Alcanza una racha de 55", "Constancia", "Medio", "200"},
            {"RACHA_60", "Dos meses", "Alcanza una racha de 60", "Constancia", "Medio", "200"},
            {"RACHA_65", "Rutina asentada", "Alcanza una racha de 65", "Constancia", "Medio", "200"},
            {"RACHA_70", "Diez semanas", "Alcanza una racha de 70", "Constancia", "Medio", "200"},
            {"RACHA_75", "Tres cuartos de cien", "Alcanza una racha de 75", "Constancia", "Medio", "200"},
            {"RACHA_80", "Ochenta", "Alcanza una racha de 80", "Constancia", "Medio", "200"},
            {"RACHA_85", "Recta final", "Alcanza una racha de 85", "Constancia", "Medio", "200"},
            {"RACHA_90", "Noventa días", "Alcanza una racha de 90", "Constancia", "Dificil", "500"},
